...
import { Dispatch, ReactElement, SetStateAction, useActionState, useEffect, useState } from "react";
  ...
  const Form = () => {
    ...
    return type === "delete" && id ? (
      <form action={formAction} className="p-4 flex flex-col gap-4">
        <input hidden name="id" defaultValue={id} type="text | number"/>
